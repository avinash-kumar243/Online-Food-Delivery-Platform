package com.quickbite.orderservice.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.quickbite.orderservice.controller..*(..))")
    public void controllerMethods() {
    }

    // Adding Aspect logs for all service methods to track business logic execution
    @Pointcut("execution(* com.quickbite.orderservice.service..*(..))")
    public void serviceMethods() {
    }

    // Adding Aspect logs for all repository methods to track database operations
    @Pointcut("execution(* com.quickbite.orderservice.repository..*(..))")
